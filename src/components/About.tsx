...
const teamMembers = [
  {
    ...
    image: `${baseUrl}images/contacts/Alex/Alex.jpg`,
    bio: [
  ...
  },
  {
    ...
    image: `${baseUrl}images/contacts/Amira/Amira_Shehatova.jpg`,
    bio: [
  ...
  },
  {
    ...
    image: `${baseUrl}images/contacts/Marek/Marek.jpg`,
    bio: [
            ...
            <div key={index} className="group animate-fade-in">
              <div className="flex flex-col sm:flex-row gap-8 lg:gap-12 pb-16 border-b border-gray-100 last:border-b-0">
                <div className="flex-shrink-0 w-full sm:w-[180px]">
                  <div className="relative w-[180px] h-[180px] mx-auto sm:mx-0 overflow-hidden mb-6 ring-1 ring-gray-200 transition-all duration-300 group-hover:ring-[#1c1c1c]">
                    <img
                      src={member.image}
                      alt={member.name}
                ...
                <div className="flex-grow space-y-5 text-center sm:text-left">
                  <div>
                    ...
                    <p className="text-[#666] text-base sm:text-lg italic mb-4 font-light tracking-wide">
                      {member.role}
                    </p>
                    <a
                  ...
                  <div className="space-y-4 pt-4">
                    {member.bio.map((paragraph, pIndex) => (
                      <p
                        key={pIndex}
                        className="text-[#2c2c2c] font-nunito text-[17px] leading-relaxed text-justify font-light"
                      >
                        {paragraph}
                      </p>
                    ))}
