    ...
    >
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="relative max-w-[500px] mx-auto text-center space-y-3 py-8">
          ...
          <div className="absolute -left-10 -top-8 text-[7em] text-white/50 font-serif leading-none">"</div>
          ...
          <div className="absolute -right-10 -bottom-8 text-[7em] text-white/50 font-serif leading-none">"</div>
        </div>
