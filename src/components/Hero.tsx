...
export const Hero = () => {
  return (
    <section className="bg-[#2b2b2b] text-white py-10 px-4 sm:px-8 lg:px-[2cm] text-center overflow-hidden mt-[60px] sm:mt-[90px]">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <div className="relative max-w-[500px] mx-auto text-center space-y-3 py-8">
          ...
          <div className="absolute -right-9 -bottom-4 text-[7em] text-white/50 font-serif leading-none">”</div>
        </div>
